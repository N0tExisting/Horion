...
DiscordActivityTimestamps* ActivityTimestamps::GetIternal() {
	return &internal_;
}
...
DiscordActivityAssets* ActivityAssets::GetIternal() {
	return &internal_;
}
...
void Activity::SetTimestamps(ActivityTimestamps t) {
	internal_.timestamps = *t.GetIternal();
}

void Activity::SetAssets(ActivityAssets a){
	internal_.assets = *a.GetIternal();
}
